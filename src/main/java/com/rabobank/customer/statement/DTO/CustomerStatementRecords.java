...
public CustomerStatementRecords(int reference, String accountNumber, String description, double startBalance,
...
public boolean equals(Object obj) {
	...
	if (getClass() != obj.getClass())
		return false;
	CustomerStatementRecords other = (CustomerStatementRecords) obj;
...
public String toString() {
	return "CustomerStatement_FailedRecords [reference=" + reference +   ", description="
